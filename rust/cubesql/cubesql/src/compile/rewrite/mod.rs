...
fn fun_expr_args(args: Vec<impl Display>) -> String {
    flat_list_expr("ScalarFunctionExprArgs", args)
}
...
fn window_window_expr(exprs: Vec<impl Display>) -> String {
    flat_list_expr("WindowWindowExpr", exprs)
}
...
fn wrapped_select_projection_expr(exprs: Vec<impl Display>) -> String {
    flat_list_expr("WrappedSelectProjectionExpr", exprs)
}
...
fn wrapped_select_group_expr(exprs: Vec<impl Display>) -> String {
    flat_list_expr("WrappedSelectGroupExpr", exprs)
}
...
fn wrapped_select_aggr_expr(exprs: Vec<impl Display>) -> String {
    flat_list_expr("WrappedSelectAggrExpr", exprs)
}
...
fn wrapped_select_window_expr(exprs: Vec<impl Display>) -> String {
    flat_list_expr("WrappedSelectWindowExpr", exprs)
}
...
fn aggregate_group_expr(exprs: Vec<impl Display>) -> String {
    flat_list_expr("AggregateGroupExpr", exprs)
}
...
fn aggregate_group_expr_legacy(left: impl Display, right: impl Display) -> String {
    format!("(AggregateGroupExpr {} {})", left, right)
}

fn aggregate_aggr_expr(exprs: Vec<impl Display>) -> String {
    flat_list_expr("AggregateAggrExpr", exprs)
}
...
fn aggregate_aggr_expr_legacy(left: impl Display, right: impl Display) -> String {
...
fn projection_expr(exprs: Vec<impl Display>) -> String {
    flat_list_expr("ProjectionExpr", exprs)
}
